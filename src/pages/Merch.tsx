...
const products: ProductProps[] = [
  {
    name: "DominionRoot Logo Tee",
    price: 29.99,
    image: "https://images.unsplash.com/photo-1521572163474-6864f9cf17ab?w=400&h=400&fit=crop",
    description: "Premium cotton t-shirt with the iconic DominionRoot logo.",
    badge: "Best Seller",
  },
  {
    name: "Spartan Hoodie",
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center max-w-3xl mx-auto">
            ...
            <p className="font-body text-lg text-muted-foreground">
              Rep the DominionRoot brand with exclusive gear and collectibles.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-2xl mx-auto text-center glass-card rounded-lg p-8">
            ...
            <p className="font-body text-muted-foreground mb-4">
              Full checkout functionality with Stripe payments is on the way. 
